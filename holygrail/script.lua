...
ForgeButtonToggle.BackgroundColor3 = Color3.fromRGB(150, 120, 0) -- Warna Emas/Oranye gelap bawaan aktif
ForgeButtonToggle.Position = UDim2.new(0.05, 0, 0.41, 0) -- Berada tepat di bawah tombol Replay        
...
StatsLabel.Position = UDim2.new(0.05, 0, 0.41, 48)
